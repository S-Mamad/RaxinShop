...
const footerLinks = [
  { label: "فروشگاه", href: "/hajiasal/shop" },
  { label: "درباره ما", href: "/hajiasal/about" },
  { label: "تماس", href: "/hajiasal/contact" },
  { label: "سوالات", href: "/hajiasal/faq" },
  { label: "پیگیری سفارش", href: "/hajiasal/track-order" },
  { label: "علاقه‌مندی‌ها", href: "/hajiasal/wishlist" },
];
