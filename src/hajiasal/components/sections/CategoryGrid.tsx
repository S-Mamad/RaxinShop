          ...
          {siteData.categories.map((cat, i) => (
            <Reveal key={cat.id} delay={i * 0.04}>
              <Link
                ...
                className="group relative block overflow-hidden rounded-xl border border-white/6 bg-surface-elevated transition-all duration-500 hover:border-gold/30 sm:rounded-2xl"
              >
