...
export function BrandStory() {
  return (
    <section id="about" className="bg-void py-14 md:py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 md:grid-cols-2 md:gap-14 md:px-8">
        <Reveal>
          <div className="relative aspect-[4/5] overflow-hidden rounded-2xl sm:aspect-[5/4] md:aspect-[4/5]">
            <Image
        ...
        <div>
          ...
          <Reveal delay={0.25} className="mt-8">
            <Button href={hajiasalPath("/about")} variant="outline">
              بیشتر درباره ما
            </Button>
          </Reveal>
        </div>
